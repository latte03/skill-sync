    ...
    <n-message-provider><n-dialog-provider>
      <div class="flex min-h-[100dvh] bg-[var(--color-paper-2)]">
        ...
        <main class="min-w-0 flex-1 bg-[var(--color-paper-2)]">
          ...
          <footer class="mx-4 flex flex-wrap justify-between gap-3 border-t border-[var(--color-rule)] py-5 text-[0.625rem] font-[var(--font-mono)] tracking-[0.09em] uppercase text-[var(--color-muted)] sm:mx-8 lg:mx-12"><span>SkillSync · local control plane</span><span>安全操作从预览开始</span></footer>
        </main>
      </div>
