    ...
    <DialogPortal>
      ...
      <DialogContent :class="['ui-dialog', `ui-dialog--${size}`]">
        <header class="ui-dialog__header">
          ...
          <DialogClose class="ui-dialog__close" aria-label="关闭"><UiIcon :component="CloseOutline" size="18" /></DialogClose>
        </header>
