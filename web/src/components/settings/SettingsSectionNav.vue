...
<template>
  <nav class="settings-nav" aria-label="设置分类">
    ...
    >
      <span class="settings-nav__icon"><n-icon :component="item.icon" size="17" /></span>
...
.settings-nav__icon { display:grid;width:2.35rem;height:2.35rem;place-items:center;border:1px solid var(--color-rule);border-radius:.7rem;background:var(--color-paper);color:currentColor; }
